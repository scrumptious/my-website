	...
	<div class="col-12 col-sm-12 col-md-12 col-xl-6 form">
		...
		<!-- <div class="col-xs-12 col-sm-12 col-md-6"> -->
				...
				<div class="row">
					...
					<div class="col-md-2 form-col"><input min="0" step="1" max="30" type="range" name="hexagonsWidth" id="hexagonsWidth" ng-model="draw.hexagonsWidth"><p class="in-the-middle">{{draw.hexagonsWidth}}</p></div>
